...
# Таблица настроек температурного контроллера DT340
DT340 = {"A1MA": {"address": 0x1116, "type": "U16", "divider": 1,      "min": 0,     "max": 100},      # Adjust Upper Limit of Analog Linear Output 1
         ...
         "AL1H": {"address": 0x1024, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Alarm 1 upper-limit
         "AL1L": {"address": 0x1025, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Alarm 1 lower-limit
         ...
         "AL2H": {"address": 0x1026, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Alarm 2 upper-limit
         "AL2L": {"address": 0x1027, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Alarm 2 lower-limit
         ...
         "AL3H": {"address": 0x1028, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Alarm 3 upper-limit
         "AL3L": {"address": 0x1029, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Alarm 3 lower-limit
         ...
         "COEF": {"address": 0x100E, "type": "U16", "divider": 100.0,  "min": 0.01,  "max": 99.99},    # The setting of COEF when Dual Loop output control are used
         "COSH": {"address": 0x1039, "type": "U16", "divider": 1,      "min": 0,     "max": 1},        # Communication write status
         "CT1":  {"address": 0x1182, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # CT1 Read Value
         "CT2":  {"address": 0x1183, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # CT2 Read Value
         ...
         "DEAD": {"address": 0x100F, "type": "I16", "divider": 10.0,   "min": -99.9, "max": 999.9},    # The setting of Dead Band when Dual Loop output control are used
         ...
         "FZDB": {"address": 0x1128, "type": "U16", "divider": 10.0,   "min": 0,     "max": 999.9},    # Fuzzy Dead Band
         ...
         "IOF":  {"address": 0x100C, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Integration default
         "LOC":  {"address": 0x102C, "type": "U16", "divider": 1,      "min": 0,     "max": 1},        # Lock status
         "O1-C": {"address": 0x1007, "type": "U16", "divider": 10.0,   "min": 1,     "max": 990},      # 1st group of Heating/Cooling control cycle
         "O1-H": {"address": 0x1007, "type": "U16", "divider": 10.0,   "min": 1,     "max": 990},      # 1st group of Heating/Cooling control cycle
         "O1-S": {"address": 0x1010, "type": "I16", "divider": 10.0,   "min": -99.9, "max": 999.9},    # Hysteresis setting value of the 1st output group
         "O1MA": {"address": 0x110E, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Upper limit of control output 1
         "O1MI": {"address": 0x110F, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Lower limit of control output 1
         "O2-C": {"address": 0x1008, "type": "U16", "divider": 10.0,   "min": 1,     "max": 990},      # 2st group of Heating/Cooling control cycle
         "O2-H": {"address": 0x1008, "type": "U16", "divider": 10.0,   "min": 1,     "max": 990},      # 2st group of Heating/Cooling control cycle
         "O2-S": {"address": 0x1011, "type": "I16", "divider": 10.0,   "min": -99.9, "max": 999.9},    # Hysteresis setting value of the 2nd output group
         "O2MA": {"address": 0x1110, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Upper limit of control output 2
         "O2MI": {"address": 0x1111, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Lower limit of control output 2
         "OUT1": {"address": 0x1012, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Output 1 value
         "OUT2": {"address": 0x1013, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Output 2 value
         "P":    {"address": 0x1009, "type": "U16", "divider": 10.0,   "min": 0.1,   "max": 999.9},    # PB Proportional band
         "PDOF": {"address": 0x100D, "type": "U16", "divider": 10.0,   "min": 0,     "max": 100},      # Proportional control offset error value, when Ti=0
         ...
         "PV":   {"address": 0x1000, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Present value
         "PV-F": {"address": 0x1102, "type": "U16", "divider": 1,      "min": 0,     "max": 50},       # Temperature filter factor
         "PV-R": {"address": 0x1101, "type": "U16", "divider": 100.0,  "min": 0.1,   "max": 10},       # Temperature filter range
         "PVGA": {"address": 0x1100, "type": "U16", "divider": 1000.0, "min": 0,     "max": 1000},     # Adjust Temperature Gain
         "PVOF": {"address": 0x1016, "type": "I16", "divider": 10.0,   "min": -99.9, "max": 99.9},     # Temperature regulation value
         ...
         "SLOP": {"address": 0x1114, "type": "U16", "divider": 10.0,   "min": 0,     "max": 1000},     # Programmable Slope Increase
         ...
         "SV":   {"address": 0x1001, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Setpoint value
         "SVN":  {"address": 0x101D, "type": "I16", "divider": 10.0,   "min": 0,     "max": 100},      # SV value corresponded to PID value
         "SVSL": {"address": 0x1104, "type": "U16", "divider": 10.0,   "min": 0,     "max": 10},       # Slope of Temperature Increase
         "TP-H": {"address": 0x1002, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Upper-limit of temperature range
         "TP-L": {"address": 0x1003, "type": "I16", "divider": 10.0,   "min": -9999, "max": 9999},     # Lower-limit of temperature range
